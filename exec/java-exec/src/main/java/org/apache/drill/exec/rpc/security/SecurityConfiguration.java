...
public class SecurityConfiguration extends Configuration {
   ...
   * The property is needed only when Hadoop classes are relocated to different namespace which
   * is done inside jdbc-all package. For normal build this property is not required as Hadoop
   * classes will be used normally.
   */
